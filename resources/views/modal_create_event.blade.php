        ...
        <div class="modal-content model-style">
            <div class="container pt-3">
                ...
                <div class="modal-body alerts">
                    <ul class="nav nav-tabs mb-2" id="myTab" role="tablist">
                        <li id="step-1" class="nav-item" role="presentation">
                            <button class="nav-link active" id="step-1-tab" data-bs-toggle="tab" data-bs-target="#home"
                        ...
                        <li id="step-2" class="nav-item" role="presentation">
                            <button class="nav-link" id="step-2-tab" data-bs-toggle="tab" data-bs-target="#profile"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div>
                                            ...
                                            <div class="row "
                                                 style=" margin: 0">
                                                <select name="type" id="event_type" class=" col-md-3 form-select-sm">
                ...
                <div class="modal-footer">
                    <button id="submit_event" class="btn btn-primary float-end">CREATE
